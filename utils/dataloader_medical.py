...
class UnetDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #   从文件中读取图像
        # -------------------------------#
        jpg = Image.open(os.path.join(os.path.join(self.dataset_path, "TrainImages"), name + ".bmp"))
        png = Image.open(os.path.join(os.path.join(self.dataset_path, "TrainLabels"), name.replace("_", "_gt_") + ".bmp"))
        # -------------------------------#
        #   数据增强
        # -------------------------------#
